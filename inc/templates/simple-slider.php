...
<?php echo wp_get_attachment_image_src(get_post_meta( $atts['id'], $meta_key, true),'full')[0];  ?>
<div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:100%;height:auto;overflow:hidden;visibility:hidden;">
<!-- Loading Screen -->
<div data-u="loading" class="jssorl-009-spin" style="position:absolute;top:0px;left:0px;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
<img style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="img/spin.svg" />
</div>
<div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:100%;height:auto;overflow:hidden;">
<div>
